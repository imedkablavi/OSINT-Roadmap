  ...
  ci: {
    collect: {
      ...
      url: [
        ...
        'http://127.0.0.1:4173/osint-for-beginners.html',
        'http://127.0.0.1:4173/osint-tools.html',
        'http://127.0.0.1:4173/tool-finder.html',
        'http://127.0.0.1:4173/search.html',
        'http://127.0.0.1:4173/username-osint.html',
        'http://127.0.0.1:4173/reverse-image-osint.html',
        'http://127.0.0.1:4173/domain-osint.html',
        'http://127.0.0.1:4173/company-osint.html',
